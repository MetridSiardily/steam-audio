...
namespace SteamAudio
{
    ...
    public class SteamAudioStaticMeshInspector : Editor
    {
        ...
        readonly GUIContent mAssetGUI = new("Asset", "Reference to the asset that contains the exported geometry data for this scene. Automatically generated by Steam Audio.");
